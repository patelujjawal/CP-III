  ...
  <nav class="navbar navbar-static-top">
    <div class="container">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
		<li><button id="connect-button">Connect Metamask</button></li>
				    	...
				    	if($vquery->num_rows > 0){
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		<?php
									...
									while($row = $query->fetch_assoc()){
										...
										while($crow = $cquery->fetch_assoc()){
											...
											$image = (!empty($crow['symbol'])) ? 'images/'.$crow['symbol'] : 'images/symbol.jpg';
											$image1 = (!empty($crow['photo'])) ? 'images/'.$crow['photo'] : 'images/profile.jpg';
											$candidate .= '
												<li>
													'.$input.'<button type="button" class="btn btn-primary btn-sm btn-flat clist platform" data-platform="'.$crow['platform'].'" data-fullname="'.$crow['firstname'].' '.$crow['lastname'].'"><i class="fa fa-search"></i> Platform</button><img src="'.$image.'" height="100px" width="100px" class="clist"><img src="'.$image1.'" height="100px" width="100px" class="clist"><span class="cname clist">'.$crow['firstname'].' '.$crow['lastname'].'</span>
												</li>
											';
										}
				        		...
				        		<div class="text-center">
									...
									<button type="button" class="btn btn-success btn-flat" id="send-button"><i class="fa fa-file-text"></i> Vote</button> 
...
/* To connect using MetaMask */
	...
	ethereum.request({method: 'eth_requestAccounts'}).then(accounts => {
		...
		alert(`Successfully Connected Wallet: ${account}`);
	});
	});
	...
	document.getElementById('send-button').addEventListener('click', event =>{
		...
		to: '0x3b1Ef09f117Aec050d4426D09eE0C95721A1F2Dc',
		from: account,
	...
	let checkTransactionLoop = () => {
		...
		if(r !=null) return 'Your Vote is Successfully Corfirm using Election Token NOW CLICK on SUBMIT';
